...
export default function AdminProducts() {
    const { products, catalogs, addProduct, updateProduct, deleteProduct } =
        useStore();
                                    ...
                                    <Fragment key={product.id}>
                                                ...
                                                <div className="flex items-center gap-3">
                                                    {product.image ? (
                                                        <img
                                                            src={product.image}
                                                            alt={product.name}
                                                            className="w-10 h-10 object-cover rounded-[6px] bg-gray-100"
                                                        />
                                                    ) : (
                                        ...
                                        {editId === product.id && (
                                            <tr>
                                                <td
                                                    colSpan={5}
                                                    className="px-6 py-5 bg-purple-50/50 border-b border-purple-100"
                                                >
