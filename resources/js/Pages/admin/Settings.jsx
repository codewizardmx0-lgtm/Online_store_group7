        ...
        <div className="space-y-6">
            <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <Input
                        label="Store Email"
                        type="email"
                        defaultValue="contact@TOPECO.com"
                    />
                    <Input
                        label="Phone Number"
                    ...
                    <Input
                        label="Support Email"
                        type="email"
                        defaultValue="support@TOPECO.com"
                    />
                </div>
            </div>
            ...
            <div className="pt-6 border-t border-gray-200">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    <Input
                        label="Twitter"
                        placeholder="https://twitter.com/TOPECO"
                    />
                    <Input
                        label="Instagram"
                        placeholder="https://instagram.com/TOPECO"
                    />
                    <Input
                        label="Facebook"
                        placeholder="https://facebook.com/TOPECO"
                    />
                    <Input
                        label="LinkedIn"
                        placeholder="https://linkedin.com/company/TOPECO"
                    />
                </div>
            </div>
        </div>
    ...
    const notifications = [
        {
            ...
            desc: "Receive notifications when new orders are placed",
        },
        {
            key: "shippingUpdates",
            title: "Shipping Updates",
            desc: "Get notified when orders are shipped",
        },
        {
            key: "lowStock",
            title: "Low Stock Alerts",
            desc: "Alerts when product stock falls below threshold",
        },
        {
            key: "newCustomers",
            title: "New Customer Sign-ups",
            desc: "Notifications for new customer registrations",
        },
        {
            key: "weeklyReports",
        ...
        },
        {
            ...
            desc: "Promotional and marketing communications",
        },
    ];
    ...
    return (
        <div className="space-y-4">
            {notifications.map(({ key, title, desc }) => (
                <div
                    key={key}
                    className="flex items-center justify-between p-4 bg-gray-50 rounded-[10px]"
                >
                    <div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-green-600">
                            Your store is connected to Stripe for payments
                        </p>
                    </div>
                </div>
            </div>
