        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-md">
              Explore our curated collection of premium products designed for modern living. Quality meets style.
            </p>
  ...
  return (
    <section className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link to="/shop" className="text-sm font-medium text-purple-600 hover:text-purple-700 flex items-center gap-1">
          View All
    ...
    <section className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="bg-purple-600 rounded-[14px] p-8 md:p-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
          ...
          />
          <Button variant="outline" size="lg" className="bg-white text-purple-600 border-white hover:bg-purple-50">
            Subscribe
          </Button>
        </div>
      </div>
