    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <Input label="Store Email" type="email" defaultValue="contact@store.com" />
          <Input label="Phone Number" defaultValue="+1 (555) 123-4567" />
          <Input label="Support Email" type="email" defaultValue="support@store.com" />
        </div>
      </div>
      ...
      <div className="pt-6 border-t border-gray-200">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <Input label="Twitter" placeholder="https://twitter.com/yourstore" />
          <Input label="Instagram" placeholder="https://instagram.com/yourstore" />
          <Input label="Facebook" placeholder="https://facebook.com/yourstore" />
          <Input label="LinkedIn" placeholder="https://linkedin.com/company/yourstore" />
        </div>
      </div>
    </div>
  )
